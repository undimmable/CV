  ...
  \begin{tabular}[t]{@{}p{\textwidth-\rcollength}@{}p{\rcollength}}
    ...
    & \parbox{\rcollength}{
      \begin{flushright}
        ...
        % \href{https://www.github.com/dimyriy}{https://github.com/dimyriy}
      \end{flushright}
    }
  \end{tabular}
}
...
\begin{outerlist}
    \item[] \textit{Senior Software Engineer, Product Owner}
...
\begin{outerlist}
    \item[] \textit{Team Lead, Senior Software Engineer}
      ...
      \begin{itemize}
        \item Created from scratch and lead our Cloud Integrations Team (at the time we had 3 people including myself)
...
\begin{outerlist}
    \item[] \textit{Senior Software Engineer}
      ...
      \begin{itemize}
        \item Lead the GDPR compliance project with a team of 6 people
